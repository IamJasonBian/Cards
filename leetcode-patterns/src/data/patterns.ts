...
export const patterns: Pattern[] = [
  {
    ...
    problems: [
      ...
      { name: "Keys and Rooms", slug: "keys-and-rooms", difficulty: "Medium" },
      ...
      { name: "Loud and Rich", slug: "loud-and-rich", difficulty: "Medium" },
    ],
...
def dfs_iterative(graph, start):
  ...
  },
  {
    ...
    problems: [
      ...
      { name: "Minimum Knight Moves", slug: "minimum-knight-moves", difficulty: "Medium" },
      ...
      { name: "Snakes and Ladders", slug: "snakes-and-ladders", difficulty: "Medium" },
    ],
...
def lis(nums):
  ...
  },
  {
    ...
    problems: [
      ...
      { name: "Maximize Greatness of an Array", slug: "maximize-greatness-of-an-array", difficulty: "Medium" },
      { name: "Sort Colors", slug: "sort-colors", difficulty: "Medium" },
      { name: "Remove Duplicates from Sorted Array", slug: "remove-duplicates-from-sorted-array", difficulty: "Easy" },
      { name: "Boats to Save People", slug: "boats-to-save-people", difficulty: "Medium" },
...
def threeSum(nums):
  ...
  },
  {
    ...
    problems: [
      ...
      { name: "Subarrays with K Different Integers", slug: "subarrays-with-k-different-integers", difficulty: "Hard" },
...
def lengthOfLongestSubstring(s):
  ...
  },
  {
    ...
    problems: [
      ...
      { name: "Capacity To Ship Packages", slug: "capacity-to-ship-packages-within-d-days", difficulty: "Medium" },
...
def exist(board, word):
  ...
  },
  {
    ...
    problems: [
      ...
      { name: "Sum of Subarray Minimums", slug: "sum-of-subarray-minimums", difficulty: "Medium" },
      { name: "Trapping Rain Water", slug: "trapping-rain-water", difficulty: "Hard" },
    ],
...
def largestRectangleArea(heights):
  ...
  },
  {
    ...
    problems: [
      ...
      { name: "Smallest Range Covering Elements from K Lists", slug: "smallest-range-covering-elements-from-k-lists", difficulty: "Hard" },
    ],
...
def quickselect(nums, k):
  ...
  },
  {
    ...
    problems: [
      ...
      { name: "Smallest String With Swaps", slug: "smallest-string-with-swaps", difficulty: "Medium" },
    ],
...
def lcs(text1, text2):
  ...
  },
  {
    ...
    problems: [
      ...
      { name: "Sequence Reconstruction", slug: "sequence-reconstruction", difficulty: "Medium" },
      { name: "Minimum Semesters for Course Plan", slug: "parallel-courses", difficulty: "Medium" },
      { name: "Sort Items by Groups Respecting Dependencies", slug: "sort-items-by-groups-respecting-dependencies", difficulty: "Hard" },
      { name: "Find All Possible Recipes from Given Supplies", slug: "find-all-possible-recipes-from-given-supplies", difficulty: "Medium" },
...
def inorder_morris(root):
  ...
  },
  {
    ...
    problems: [
      ...
      { name: "Path with Maximum Probability", slug: "path-with-maximum-probability", difficulty: "Medium" },
      { name: "Path With Minimum Effort", slug: "path-with-minimum-effort", difficulty: "Medium" },
      ...
      { name: "Find the City With the Smallest Number of Neighbors", slug: "find-the-city-with-the-smallest-number-of-neighbors-at-a-threshold-distance", difficulty: "Medium" },
      { name: "Minimum Cost to Make at Least One Valid Path in a Grid", slug: "minimum-cost-to-make-at-least-one-valid-path-in-a-grid", difficulty: "Hard" },
    ],
...
def reverseKGroup(head, k):
  ...
  },
  {
    ...
    problems: [
      ...
      { name: "Rotting Oranges", slug: "rotting-oranges", difficulty: "Medium" },
      { name: "Word Search", slug: "word-search", difficulty: "Medium" },
      { name: "The Maze", slug: "the-maze", difficulty: "Medium" },
    ],
...
def shortestPathBinaryMatrix(grid):
  ...
  },
  {
    ...
    problems: [
      ...
      { name: "Number of Distinct Islands", slug: "number-of-distinct-islands", difficulty: "Medium" },
      { name: "Count Sub Islands", slug: "count-sub-islands", difficulty: "Medium" },
      ...
      { name: "Bricks Falling When Hit", slug: "bricks-falling-when-hit", difficulty: "Hard" },
    ],
...
def largestIsland(grid):
  ...
  },
  {
    ...
    problems: [
      ...
      { name: "Find All Anagrams in a String", slug: "find-all-anagrams-in-a-string", difficulty: "Medium" },
      ...
      { name: "Sort Characters By Frequency", slug: "sort-characters-by-frequency", difficulty: "Medium" },
      { name: "Ransom Note", slug: "ransom-note", difficulty: "Easy" },
      { name: "Custom Sort String", slug: "custom-sort-string", difficulty: "Medium" },
    ],
...
def minWindow(s, t):
  ...
  },
  {
    ...
    tag: "String",
    problems: [
      { name: "Implement Trie", slug: "implement-trie-prefix-tree", difficulty: "Medium" },
      ...
      { name: "Longest Word in Dictionary", slug: "longest-word-in-dictionary", difficulty: "Medium" },
...
def findWords(board, words):
  ...
  },
  {
    ...
    problems: [
      ...
      { name: "Valid Palindrome II", slug: "valid-palindrome-ii", difficulty: "Easy" },
      { name: "Longest Palindrome", slug: "longest-palindrome", difficulty: "Easy" },
      { name: "Palindrome Partitioning", slug: "palindrome-partitioning", difficulty: "Medium" },
      ...
      { name: "Break a Palindrome", slug: "break-a-palindrome", difficulty: "Medium" },
      { name: "Longest Palindromic Subsequence", slug: "longest-palindromic-subsequence", difficulty: "Medium" },
    ],
...
def longestPalindromeBuild(s):
  ...
  },
  {
    ...
    problems: [
      ...
      { name: "Parallel Courses", slug: "parallel-courses", difficulty: "Medium" },
      { name: "Find All Possible Recipes from Given Supplies", slug: "find-all-possible-recipes-from-given-supplies", difficulty: "Medium" },
      { name: "Longest Increasing Path in a Matrix", slug: "longest-increasing-path-in-a-matrix", difficulty: "Hard" },
      { name: "Sequence Reconstruction", slug: "sequence-reconstruction", difficulty: "Medium" },
      { name: "Sort Items by Groups Respecting Dependencies", slug: "sort-items-by-groups-respecting-dependencies", difficulty: "Hard" },
      { name: "Loud and Rich", slug: "loud-and-rich", difficulty: "Medium" },
      { name: "Course Schedule IV", slug: "course-schedule-iv", difficulty: "Medium" },
    ],
...
def topoSort(n, prereqs):
  ...
  },
  {
    ...
    problems: [
      { name: "Course Schedule", slug: "course-schedule", difficulty: "Medium" },
      { name: "Course Schedule II", slug: "course-schedule-ii", difficulty: "Medium" },
      { name: "Design Task Manager", slug: "design-task-manager", difficulty: "Medium" },
    ],
...
# slow is at the middle`,
    relatedProblems: [
      { name: "Diameter of Binary Tree", slug: "diameter-of-binary-tree", difficulty: "Easy" },
      { name: "Lowest Common Ancestor", slug: "lowest-common-ancestor-of-a-binary-tree", difficulty: "Medium" },
      { name: "Validate BST", slug: "validate-binary-search-tree", difficulty: "Medium" },
      { name: "Reverse Linked List", slug: "reverse-linked-list", difficulty: "Easy" },
      { name: "Merge Two Sorted Lists", slug: "merge-two-sorted-lists", difficulty: "Easy" },
      { name: "Reorder List", slug: "reorder-list", difficulty: "Medium" },
    ],
...
edges.sort(key=lambda e: e.weight)  # Kruskal's`,
    relatedProblems: [
      ...
      { name: "Shortest Path to Get All Keys", slug: "shortest-path-to-get-all-keys", difficulty: "Hard" },
      { name: "Serialize and Deserialize Binary Tree", slug: "serialize-and-deserialize-binary-tree", difficulty: "Hard" },
      { name: "LRU Cache", slug: "lru-cache", difficulty: "Medium" },
    ],
  },
...
def findWords(board, words):
    ...
    relatedProblems: [
      ...
      { name: "Longest Word in Dictionary", slug: "longest-word-in-dictionary", difficulty: "Medium" },
      { name: "Map Sum Pairs", slug: "map-sum-pairs", difficulty: "Medium" },
      { name: "Maximum XOR of Two Numbers", slug: "maximum-xor-of-two-numbers-in-an-array", difficulty: "Medium" },
    ],
  },
  {
...
def max_width(root):
    ...
    relatedProblems: [
      ...
      { name: "Find Bottom Left Tree Value", slug: "find-bottom-left-tree-value", difficulty: "Medium" },
      { name: "Maximum Width of Binary Tree", slug: "maximum-width-of-binary-tree", difficulty: "Medium" },
      { name: "Binary Tree Zigzag Level Order", slug: "binary-tree-zigzag-level-order-traversal", difficulty: "Medium" },
      { name: "Average of Levels in Binary Tree", slug: "average-of-levels-in-binary-tree", difficulty: "Easy" },
      { name: "Populating Next Right Pointers", slug: "populating-next-right-pointers-in-each-node", difficulty: "Medium" },
...
def isPalindrome(head):
    ...
    relatedProblems: [
      { name: "Reverse Linked List", slug: "reverse-linked-list", difficulty: "Easy" },
      { name: "Reverse Linked List II", slug: "reverse-linked-list-ii", difficulty: "Medium" },
      ...
      { name: "Reorder List", slug: "reorder-list", difficulty: "Medium" },
      { name: "Add Two Numbers", slug: "add-two-numbers", difficulty: "Medium" },
      { name: "Odd Even Linked List", slug: "odd-even-linked-list", difficulty: "Medium" },
    ],
  },
  {
