...
function DSCard({ entry }: { entry: DSRefEntry }) {
  ...
  return (
    <div className={`rounded-none border ${borderClass} bg-slate-900/85 sm:bg-slate-900/70 backdrop-blur-2xl`}>
      <button
      ...
      >
        ...
        <div className="flex items-center gap-2">
          <a
            ...
            className="inline-flex items-center gap-1 px-2 py-1 rounded-none text-xs font-medium text-cyan-400 hover:bg-cyan-500/10 transition-colors"
          >
            Python Docs
      ...
      {open && (
        <div className="border-t border-white/5 px-4 pb-4 pt-3 space-y-3">
          <pre className="bg-slate-800/90 text-slate-100 rounded-none p-4 text-xs leading-relaxed overflow-x-auto">
            ...
            <div className="flex items-center justify-between mb-2">
              ...
              {entry.relatedProblems.length > VISIBLE_COUNT && (
                <button
                  ...
                  className="flex items-center gap-1 px-2 py-1 rounded-none text-xs text-cyan-400 hover:text-cyan-300 hover:bg-cyan-500/10 border border-transparent hover:border-cyan-500/30 transition-colors cursor-pointer"
                >
