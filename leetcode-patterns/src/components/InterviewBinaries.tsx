        ...
        <section>
          ...
          <div className="space-y-4">
            {coderpadProblems.map((problem, idx) => (
              <div
                key={idx}
                className="bg-slate-900/20 backdrop-blur-2xl border border-white/10 rounded-2xl p-6 hover:shadow-md transition-shadow"
              >
                ...
                <div className="border-t border-white/5 pt-4">
                  ...
                  <ul className="grid grid-cols-2 gap-2">
                    {problem.parts.map((part, partIdx) => (
                      ...
                      >
                        <span className="w-5 h-5 rounded-full bg-slate-800/15 text-slate-300 flex items-center justify-center text-xs font-medium">
                          {partIdx + 1}
                        </span>
                        {part}
                      </li>
