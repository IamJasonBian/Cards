...
export function TagRail({ onNavigate }: { onNavigate: (view: string) => void }) {
  return (
    <section className="mx-auto w-full max-w-5xl px-4 sm:px-6 py-10 sm:py-12 text-center">
      <p className="inline-block bg-white/95 px-3 py-1 sm:bg-transparent sm:px-0 sm:py-0 text-xs font-semibold uppercase tracking-[0.15em] text-slate-500 sm:[text-shadow:_0_1px_12px_rgb(255_255_255_/_80%)]">
        Topics
      </p>
